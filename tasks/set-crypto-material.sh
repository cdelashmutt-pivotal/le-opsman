...
curl "https://$OPSMAN_HOST/api/v0/settings/ssl_certificate" -X PUT -H "Authorization: Bearer $ACCESS_TOKEN" -H "Content-Type: application/json" -d "{\"ssl_certificate\": { \"certificate\": \"$CERT\", \"private_key\": \"$KEY\" } }" -v
